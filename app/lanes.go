...
// we create two separate lanes - Keyshare, and Default - and then return them.
//
// NOTE: Application Developers should closely replicate this function in their own application.
func CreateLanes(app *LazyApp) (*keysharelane.KeyShareLane, *base.BaseLane) {
	...
	// Create a default configuration that accepts 10000 transactions and consumes 80% of the
	// block space.
